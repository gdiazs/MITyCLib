...
/**
 * <p>Tests de funcionamiento de las operaciones sobre el una tarjeta DNIe.</p>
 ...
 * <pre>
 * # Ruta del módulo PKCS#11 de DNIe
 * test.p11.dnie=
 * </pre>
 * </p>
 * 
 */
public class TestDNIeStore extends KeyStoreTests {
	...
	public void initialize() {
		try {
			...
			libP11 = rb.getString("test.p11.dnie");
	...
	public IPKStoreManager getStore() {
		return new PKCS11Store(libP11, new HandlerPassPKCS11Store("Acceso a DNIe"));
	}

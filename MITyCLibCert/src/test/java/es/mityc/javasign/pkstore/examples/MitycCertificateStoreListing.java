...
/**
 * <p>
 * Ejemplo que lista el almacén de certificados de Java a través de 
 * las clases contenidas en mitycstore.
 * </p>
 * 
 */
public class MitycCertificateStoreListing extends
        GenericCertificateStoreListing {
	
	private final static String CONF_FILE = "/MITyC_KS.properties";
    ...
    public static void main(String[] args) {
        MitycCertificateStoreListing certificateStoreListing = new MitycCertificateStoreListing();
        certificateStoreListing.execute();
    }

    @Override
    protected IPKStoreManager getPKStoreManager() {
    	// Se carga la configuración del almacén    	

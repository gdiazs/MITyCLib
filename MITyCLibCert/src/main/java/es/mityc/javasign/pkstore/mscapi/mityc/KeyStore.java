...
abstract class KeyStore extends KeyStoreSpi {
    ...
    class KeyEntry
    {
        ...
        KeyEntry(String alias, Key key, X509Certificate[] chain) {
             ...
             */
             if (alias == null) {
                 this.oldAlias = Integer.toString(chain[0].hashCode());
             } else {
                 this.oldAlias = alias;
             }
             this.alias = Long.toString(getEntryCount());
        }
    ...
    /** Contador de entradas utilizado para obtener alias distintos. */
